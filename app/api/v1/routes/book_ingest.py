...
async def ingest_book(
    ...
    book_title: str = Form(..., min_length=1, max_length=200),
    book_author: Optional[str] = Form(default=None, max_length=100),
    subject: Optional[str] = Form(default=None, max_length=100),
