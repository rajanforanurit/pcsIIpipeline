...
async def list_english_questions(
...
async def update_english_question(
    question_id: str,
...
async def delete_english_question(
    question_id: str,
    current_admin: str = Depends(get_current_admin),
    db: AsyncIOMotorDatabase = Depends(get_db),
) -> SuccessResponse:
...
async def approve_english_question(
    question_id: str,
    current_admin: str = Depends(get_current_admin),
    db: AsyncIOMotorDatabase = Depends(get_db),
) -> SuccessResponse:
...
async def bulk_approve_english_questions(
