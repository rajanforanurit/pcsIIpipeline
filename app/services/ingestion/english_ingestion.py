...
async def run_english_ingestion(job_id: str, db: AsyncIOMotorDatabase) -> None:
    ...
    q_repo = EnglishQuestionRepository(db)
    try:
        ...
        raw = parse_english_questions(text=text, year=job_doc['year'], exam=job_doc['exam'], paper=job_doc['paper'], set_name=job_doc.get('set_name'), job_id=job_id)
